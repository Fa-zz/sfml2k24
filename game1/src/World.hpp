...
private:
    ...
    // TODO: If allTerrains_ is just used for destructor, I think we can just iterate over terrainMap_ and delete each, making it obsolete
    unordered_map<string, Terrain*> terrainMap_; // terrainMap_: This maps every terrain object to an ID provided from Tiled. Used to determine ground and building tile at every location of the game board. See genTiles()
